...
<template>
  <div class="edit-container">
      ...
      <div class="header-content">
        ...
        <div class="header-info">
          ...
          <div>
            ...
            <div class="category-id">Category ID: #{{ categoryId }}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Edit Form -->
    <form v-else @submit.prevent="updateCategory" class="edit-form">
      ...
      <div class="form-actions">
        <div class="action-buttons">
          ...
          <button type="button" class="reset-button" @click="fetchCategory">
            <span class="button-icon">↺</span>
            Reset Changes
          </button>
